...
public class client3  implements ActionListener,Runnable{
    ...
    // Declaring colors
    Color pinkish = new Color(245,48,94);
    ...
    client3(){
        ...
        frame.setTitle("userThird");
        topPanel =new JPanel();
        topPanel.setLayout(null);
        topPanel.setBackground(pinkish);
        ...
        JLabel activeStatus = new JLabel("You, Nikhil, Rohit");
        ...
        sendButton.setBackground(pinkish);
    ...
    public void actionPerformed(ActionEvent ae) {
        ...
        try {
            ...
            String out = "<b style=\"color:white;\"><u>Harshdip:</u></b><br>"+msgField.getText();        
    ...
    public static JPanel formatLabel(String out) {
        ...
        l1.setBackground(new Color(245,48,94));
